...
Public Class AccountController
    ...
    Public Function Manage(ByVal message As ManageMessageId?) As ActionResult
        ViewData("StatusMessage") =
            If(message = ManageMessageId.ChangePasswordSuccess, "你的密码已更改。", _
                If(message = ManageMessageId.SetPasswordSuccess, "已设置你的密码。", _
                    If(message = ManageMessageId.RemoveLoginSuccess, "已删除外部登录名。", _
                        If(message = ManageMessageId.UnknownError, "出现错误。", _
                        ""))))
